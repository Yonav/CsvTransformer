...
class ColumnTransformationFuncTest {
    Table table;
    ...
    public void test() {
        // arrange & act
        new ColumnTransformationFunc("second", (t) -> t + "_" + t).apply(table);
        ...
        assertThat(table.getContent()).allMatch(row -> row.getCells().get(1).equals("second_1_second_1"));
    }
}